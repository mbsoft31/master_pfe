                                ...
                                @forelse($faculties as $faculty)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 space-x-2 whitespace-nowrap text-end text-sm font-medium">
                                            <button wire:click="$emit('editFaculty', {{ $faculty }})" class="inline-block text-indigo-600 hover:text-indigo-900">{{__('Edit')}}</button>
                                            <button wire:click="$emit('deleteFaculty', {{ $faculty }})" class="inline-block text-red-600 hover:text-red-900">{{__('Delete')}}</button>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
