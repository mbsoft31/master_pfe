...
window.Dropdown = bootstrap_js_src_dropdown__WEBPACK_IMPORTED_MODULE_0__.default;
...
class Dropdown extends _base_component__WEBPACK_IMPORTED_MODULE_5__.default {
  ...
  show() {
    ...
    if ('ontouchstart' in document.documentElement &&
      ...
      [].concat(...document.body.children)
        .forEach(elem => _dom_event_handler__WEBPACK_IMPORTED_MODULE_2__.default.on(elem, 'mouseover', _util_index__WEBPACK_IMPORTED_MODULE_0__.noop))
    }
  ...
  _completeHide(relatedTarget) {
    ...
    if ('ontouchstart' in document.documentElement) {
      [].concat(...document.body.children)
        .forEach(elem => _dom_event_handler__WEBPACK_IMPORTED_MODULE_2__.default.off(elem, 'mouseover', _util_index__WEBPACK_IMPORTED_MODULE_0__.noop))
    }
  ...
  _selectMenuItem(event) {
    const items = _dom_selector_engine__WEBPACK_IMPORTED_MODULE_4__.default.find(SELECTOR_VISIBLE_ITEMS, this._menu).filter(_util_index__WEBPACK_IMPORTED_MODULE_0__.isVisible)
...
class Modal extends _base_component__WEBPACK_IMPORTED_MODULE_5__.default {
  ...
  hide(event) {
    ...
    if (isAnimated) {
      ...
      _dom_event_handler__WEBPACK_IMPORTED_MODULE_1__.default.one(this._element, 'transitionend', event => this._hideModal(event))
  ...
  _showElement(relatedTarget) {
    ...
    if (isAnimated) {
      ...
      _dom_event_handler__WEBPACK_IMPORTED_MODULE_1__.default.one(this._dialog, 'transitionend', transitionComplete)
  ...
  _adjustDialog() {
    const isModalOverflowing = this._element.scrollHeight > document.documentElement.clientHeight
    const scrollbarWidth = (0,_util_scrollbar__WEBPACK_IMPORTED_MODULE_4__.getWidth)()
...
class Backdrop {
  ...
  _emulateAnimation(callback) {
    ...
    const backdropTransitionDuration = (0,_index__WEBPACK_IMPORTED_MODULE_1__.getTransitionDurationFromElement)(this._getElement())
    _dom_event_handler__WEBPACK_IMPORTED_MODULE_0__.default.one(this._getElement(), 'transitionend', () => (0,_index__WEBPACK_IMPORTED_MODULE_1__.execute)(callback))
...
/******/ 	__webpack_require__.O(undefined, ["css/app","resources/css/components"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app","resources/css/components"], () => (__webpack_require__("./resources/sass/components.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app","resources/css/components"], () => (__webpack_require__("./resources/css/app.css")))
